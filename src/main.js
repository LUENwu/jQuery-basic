...
这个称为jQuery构造的对象,而这些元素里有些方法,可以操控对应的元素来改变页面.*/
// api.addClass('red').addClass('blue').addClass('black') //由于返回了对象,可再次使用方法去添加/删除,这是链式操作
jQuery('.test')
      .find('.child')
      .addClass('red')
      .addClass('blue')
...
const api4 = jQuery('.test1').index()

//  api3.addClass('yellow').each((div=>console.log(div)))
